...
def main():
    ...
    parser.add_argument("--N", default=3, type=int, help="Number of steps in each coefficient")
    parser.add_argument("--Ngrid_low", default=100, type=int, help="Gridsize for the fast calculation of the norm in the simplex algorithm.")
    parser.add_argument("--Ngrid_high", default=1000, type=int, help="Gridsize for the accurate norm calculation after simplex  run.")
    parser.add_argument("--Y", default=1, help="Grid aspect ratio dy/dx")
    parser.add_argument("--deltaxrange", default=[-1,1], nargs=2, type = float, help="Range of deltax, expects two arguments: min max")
    parser.add_argument("--deltayrange", default=[-1,1], nargs=2, type = float, help="Range of deltay, expects two arguments: min max")
    parser.add_argument("--betaxyrange", default=[-1,1], nargs=2, type = float, help="Range of betaxy, expects two arguments: min max")
    parser.add_argument("--betayxrange", default=[-1,1], nargs=2, type = float, help="Range of betayx, expects two arguments: min max")
    parser.add_argument("--Trange", default=[0.1,1], nargs=2, type = float, help="Range of T=dt/dx, expects two arguments: min max")
